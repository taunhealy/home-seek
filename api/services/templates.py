    ...
    <div style="{get_base_styles()}">
        <div style="max-width: 600px; margin: 0 auto; background-color: #111111; border: 1px solid rgba(255,255,255,0.05); border-radius: 32px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.4);">
            ...
            <div style="padding: 40px 40px 20px 40px; text-align: center;">
                <div style="font-size: 10px; font-weight: 900; color: #10B981; text-transform: uppercase; letter-spacing: 0.4em; margin-bottom: 8px;">Home-Seek Intelligence</div>
            ...
            <div style="padding: 40px; text-align: center; border-top: 1px solid rgba(255,255,255,0.05); background-color: rgba(255,255,255,0.01);">
                <p style="font-size: 10px; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 0.2em; margin: 0;">This intelligence was gathered autonomously by the Home-Seek Sniper Engine.</p>
...
def get_match_template(listing):
    ...
    return wrap_content(f"""
        <div style="padding: 0 40px 40px 40px;">
            ...
            <div style="background-color: rgba(255,255,255,0.03); border-radius: 20px; padding: 24px; margin-bottom: 32px; border: 1px solid rgba(255,255,255,0.05);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div style="margin-bottom: 15px;">
                        <span style="font-size: 9px; font-weight: 800; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 0.1em; display: block; margin-bottom: 4px;">Neighborhood</span>
                        <span style="font-size: 14px; font-weight: 600;">{listing.get('address', 'Cape Town')}</span>
                    </div>
                    <div style="margin-bottom: 15px;">
                        <span style="font-size: 9px; font-weight: 800; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 0.1em; display: block; margin-bottom: 4px;">Specs</span>
                        <span style="font-size: 14px; font-weight: 600;">{listing.get('bedrooms', 'N/A')} Beds | {listing.get('property_sub_type', 'Whole')}</span>
                    </div>
                </div>
                <div style="margin-top: 10px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.05);">
                    <span style="font-size: 9px; font-weight: 800; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 0.1em; display: block; margin-bottom: 4px;">AI Insight</span>
                    <p style="font-size: 13px; color: rgba(255,255,255,0.7); margin: 0; line-height: 1.5;">{listing.get('ai_summary', 'Fresh listing matching your alert criteria.')}</p>
                </div>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                                <span style="font-weight: 700; display: block;">Home-Seek Subscription</span>
